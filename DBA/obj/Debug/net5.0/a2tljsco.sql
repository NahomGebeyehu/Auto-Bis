...
CREATE TABLE [Buses] (
    ...
    CONSTRAINT [FK_Buses_Routes_route_id] FOREIGN KEY ([route_id]) REFERENCES [Routes] ([route_id]) ON DELETE NO ACTION
);
GO
...
CREATE INDEX [IX_Buses_route_id] ON [Buses] ([route_id]);
GO
...
VALUES (N'20220920091422_init', N'5.0.17');
GO
