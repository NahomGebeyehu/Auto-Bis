...
CREATE TABLE [Routes] (
    ...
    [Stationsstation_id] bigint NULL,
    CONSTRAINT [PK_Routes] PRIMARY KEY ([route_id]),
    CONSTRAINT [FK_Routes_Stations_Stationsstation_id] FOREIGN KEY ([Stationsstation_id]) REFERENCES [Stations] ([station_id]) ON DELETE NO ACTION
);
GO
...
CREATE INDEX [IX_Routes_Stationsstation_id] ON [Routes] ([Stationsstation_id]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220901005311_initial', N'5.0.17');
GO
